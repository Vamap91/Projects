...
""", unsafe_allow_html=True)# SKILLS PAGE
elif page == "Skills":
    st.markdown("""
    <div class="header-container">
    ...
    st.markdown('</div>', unsafe_allow_html=True)# EXPERIENCE PAGE
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True)    # Project 6: FERT Workflow
    st.markdown("""
    <div class="project-card">
    ...
    with col2:
        ...
        st.plotly_chart(fig, use_container_width=True)    # Project 5: SmartCost
    st.markdown("""
    <div class="project-card">
    ...
    st.plotly_chart(fig, use_container_width=True)    # Project 4: Fast Track
    st.markdown("""
    <div class="project-card">
    ...
    st.plotly_chart(fig, use_container_width=True)    # Project 3: Oráculo
    st.markdown("""
    <div class="project-card">
    ...
    st.plotly_chart(fig, use_container_width=True)    # Project 2: MirrorGlass
    st.markdown("""
    <div class="project-card">
    ...
    with col2:
        try:
            ...
            st.image("https://via.placeholder.com/800x450?text=MirrorGlass+Analysis", caption="Texture analysis with Heat Map", use_column_width=True)# PROJECTS PAGE
elif page == "Projects":
    # Header section
    st.markdown("""
    <div class="header-container">
    ...
    with col2:
        try:
            ...
            st.image("https://via.placeholder.com/800x450?text=HeatGlass+Analysis", caption="Full analysis with checklist and risk indicators", use_column_width=True)# PROFILE PAGE
if page == "Profile":
    # Header
    st.markdown("""
    <div class="header-container">
